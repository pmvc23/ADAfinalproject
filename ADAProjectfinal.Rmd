...
```
```{r}
#creating a flow diagram for my case selection analysis
...
```
```{r}
# generating my table 1 for my analysis
table1_gt <- mat_cc %>%
...
```{r}
# Generating publication ready VIF tables
